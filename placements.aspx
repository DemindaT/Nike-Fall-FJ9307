<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="placements.aspx.cs" Inherits="WebApplication2.placements" %>
                    ...
                    <form id="documentForm" method="post" enctype="multipart/form-data" runat="server">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <label for="cut">Cut Panel:</label>
                                <select id="cut" name="cut" class="form-control" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="MinWidth">Minimum Usable Width :</label>
                                <input type="text" id="MinWidth" name="MinWidth" class="form-control">
                            </div>
                        </div>
